# Портфолио проектов по специальности Data Science
...
| [Отток клиентов банка](similarity_search) | Прогнозирование оттока клиентов из банка| *pandas, seaborn, phik, sklearn* |
